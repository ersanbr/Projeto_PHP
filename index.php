...
<html lang="UTF-8" ng-app="ProjetoIndex">
    ...
    <link rel="shortcut icon" href="adm/imagens/favicon.ico" />
    <base href="/universidade/">
	</head>
		...
		<!-- Topper w/ logo -->
			<div class="row hidden-xs topper">
				<div class="col-xs-7 col-sm-7">
					<a href="#"><img am-TopLogo alt="SECUREVIEW"  src="adm/imagens/logo.png" class="img-responsive"></a>
				</div>
					...
					<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse navbar-ex1-collapse">
							<ul class="nav navbar-nav js-nav-add-active-class" id="menu">
								<li><a href="/universidade/">Home</a></li>
								...
								<?php
									...
									while($row=$exib->fetch()){
										echo "<li id=".$row['idcategoria']."><a href='listaCursos/".$row['idcategoria']."'>".$row['descricao']."</a></li>";
									}
									$conn = null;
								?>
					  		</ul>
					  		<ul class="nav navbar-nav navbar-right hidden-xs">
								<a type="button" class="navbar-btn btn btn-gradient-blue" am-latosans="bold" href="adm/" target="_blank">Admin</a>
					  		</ul>
						</div><!-- /.navbar-collapse -->
				  	</div>
				</nav>
